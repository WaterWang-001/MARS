...
By bridging real-world data with Large Language Models (LLMs), MARS enables sociologists and researchers to simulate information propagation, public opinion evolution, and social interventions with unprecedented realism.

---

## 🚀 Key Features

The following functions are currently supported and **actively updated**:
...
* **Tier 1: LLM Agents (SocialAgent)** 🧠
    ...
    * **Mechanism:** Powered by SOTA LLMs (e.g., Qwen2.5, GPT-4). They utilize complex personas, memory, and reasoning to generate high-quality content and perform nuanced social actions.
...
Simulations are optimized through smart scheduling to mimic realistic behavior:

* **Automatic Categorization:** Users are automatically classified into groups based on their raw data profiles (e.g., *follower counts*, *posting frequency*).
* **Probabilistic Activation:** Agents are not "always online."
    * High-influence agents (Tier 1) have higher activation probabilities.
    * Tier 2 agents are activated sparsely, simulating realistic circadian rhythms and online activity patterns.
...
* **Internal Update:** Calls `update_internal_attitude` Tool to adjust its own psychological state (e.g., emotion, stance) based on the environment.
...
* 📢 **Broadcast:** Global system messages visible to *all* agents (e.g., *"Breaking News: Earthquake in Region X"*).
...
* 🤖 **Register User (Astroturfing):** Dynamically inject new Agents (e.g., *"Water Army"* or *"PR Bots"*) into the simulation at specific time steps with pre-defined profiles, attitudes, and immediate missions.

---

### 🚧 Status
We are continuously developing and refining MARS. **Stay Tuned for updates!**
